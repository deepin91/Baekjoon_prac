...
//		List<Map<Integer, Integer>> medalStanding = new ArrayList<>();
//		List<Map<Integer, Integer>> nationAndRank = new ArrayList<>();
//		
//		while (true) {
...
//			int nations = Integer.parseInt(data[0]);
//			int rank = Integer.parseInt(data[1]);
//
//			Map<Integer, Integer> map = new HashMap<>();
//			map.put(nations, rank);
//			nationAndRank.add(map);
//		
//		}
//		
////		int n = nationAndRank.get(nations);
//		int []arr = new int[3];
////		for(int i = 0; i < 3; i++) {
//			String input2 = br.readLine();
//			String[] lists = input2.split(" ");
//			
...
//			map1.put(nc, arr1);
////			medalStanding.add(map1);
//		
//		
////		for(Map<Integer,Integer> map : ) {
//			
//			System.out.println(nationAndRank);
//			
//		}
//
//	}
